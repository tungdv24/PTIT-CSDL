-- =====================================================================
-- SCHEMA CHUNG cho MOI node phan tan (HN / DN / HCM)
-- Giong ban tap trung, THEM cot `khu_vuc` vao CONG_TY va VAN_PHONG de phan manh.
-- Moi node co cung cau truc bang; du lieu duoc phan manh khi nap seed.
-- =====================================================================
CREATE DATABASE IF NOT EXISTS QuanLyToaNha CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE QuanLyToaNha;

-- ---- DANH MUC CHUNG (se duoc nhan ban giong nhau o 3 node) ----
...
CREATE TABLE IF NOT EXISTS VAN_PHONG (
    ...
    khu_vuc VARCHAR(10) NOT NULL DEFAULT 'HN',   -- HN / DN / HCM
...
-- ---- BANG NGUOI DUNG (nhan ban o 3 node de dang nhap tai bat ky chi nhanh) ----
-- vai_tro: ADMIN (tru so HN), BQL, NVCT, CONG_TY
-- khu_vuc: chi nhanh ma user thuoc ve (HN/DN/HCM)
