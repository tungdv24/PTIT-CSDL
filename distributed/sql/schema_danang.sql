-- =====================================================================
-- SCHEMA CHI NHANH DA NANG (node db_danang) - CHI CO CAU TRUC BANG (chua co data)
-- Chay: mysql -uroot -pDistPass123 < schema_danang.sql
...
-- ---- Nhan vien toa nha khu vuc Da Nang (phan manh) ----
CREATE TABLE IF NOT EXISTS NHAN_VIEN_TOA_NHA (
    ...
    email VARCHAR(100),
    khu_vuc VARCHAR(10) NOT NULL DEFAULT 'DN',
